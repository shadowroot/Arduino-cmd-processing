...
class CMDRouter{
    public:
        CMDRouter(unsigned int deviceID, AsyncComm* cmdSerial1, AsyncComm* cmdSerial2, Log* log): deviceID(deviceID), cmdSerial1(cmdSerial1), cmdSerial2(cmdSerial2), log(log){}
        void setup_hook(){
